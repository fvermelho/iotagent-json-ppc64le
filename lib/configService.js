...
function processEnvironmentVariables() {
    ...
    if (process.env.IOTA_CTX_PORT) {
      config.iota.contextBroker.port = process.env.IOTA_CTX_PORT;
    }

    if (process.env.IOTA_CTX_HOST) {
      config.iota.contextBroker.host = process.env.IOTA_CTX_HOST;
    }

    if (process.env.IOTA_DB_PORT) {
      config.iota.mongodb.port = process.env.IOTA_DB_PORT;
    }

    if (process.env.IOTA_DB_HOST) {
      config.iota.mongodb.host = process.env.IOTA_DB_HOST;
    }
}
